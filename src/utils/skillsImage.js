...
import cdns from "../assets/svg/skills/cdnsLogo.jpg";
import cdnsLogoBlack from "../assets/svg/skills/cdnsLogoBlack.png";
import siem from "../assets/svg/skills/siemLogo.jpg";
import snps from "../assets/svg/skills/snpsLogo.jpg";
import windows from "../assets/svg/skills/windowsLogo.png";
import linux from "../assets/svg/skills/Linux_Logo.png";


export const skillsImage = (skill) => {
    const skillID = skill.split(" ")[0].toLowerCase();
